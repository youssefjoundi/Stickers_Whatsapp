...
import com.Flowers.animatedstickers.BuildConfig;
import com.Flowers.animatedstickers.R;
import com.Flowers.animatedstickers.StickerPack;
import com.Flowers.animatedstickers.adapters.StickerPackListAdapter;
import com.Flowers.animatedstickers.stickerloader.WhitelistCheck;
...
//        AdsManager.getInstance().showBannerIronSource(this);
    ...
    public void email(){
        String email=StickerPackListActivity.this.getResources().getString(R.string.email_tag);
