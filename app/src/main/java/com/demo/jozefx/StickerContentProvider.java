...
public class StickerContentProvider extends ContentProvider {
    ...
    public static final Uri AUTHORITY_URI = new Uri.Builder().scheme(ContentResolver.SCHEME_CONTENT).authority(BuildConfig.CONTENT_PROVIDER_AUTHORITY).appendPath(com.demo.jozefx.StickerContentProvider.METADATA).build();
